...
- [미국·일본 예상 세금](docs/PORTFOLIO_TAX.md)은 **2026년 한국 세법의 일반 과세를 가정한 별도 계산기**다. 모든 실계좌의 세금용 원화 실현손익을 사용자가 입력하며, 공제 250만 원을 합산 1회 적용한다. 모의·국내주식·배당·특례는 제외하고 자동매매 누적손익을 세금 자료로 간주하지 않는다. 입력은 저장·전송하지 않는다.
